  ...
  return (
    <>
      <Head>
        ...
        <meta name='description' content='Claim your OG $CIL Airdrop!' />
      </Head>
              ...
              <div className='lg:max-w-lg'>
                ...
                {status === AirdropState.CLOSED && (
                  <p className='mt-6 text-lg leading-8 text-center text-gray-600 md:text-start'>
                    Woops! The OG Airdrop has been completed.
                  </p>
                )}
                <p className='mt-6 text-lg leading-8 text-center text-gray-600 md:text-start'>
                  {airdropWhitelisted
                    ? `You are eligible to claim the OG Airdrop!\
                  Get OG Airdrop by Clicking Claim Button.`
                    : `In order to participate in Cilistia's OG Airdrop your wallet\
